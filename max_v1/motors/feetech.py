...
# Définir les classes et fonctions manquantes localement
...
class RobotDeviceAlreadyConnectedError(Exception):
    def __init__(self, message="Device is already connected"):
        self.message = message
        super().__init__(self.message)

class RobotDeviceNotConnectedError(Exception):
    def __init__(self, message="Device is not connected"):
        self.message = message
        super().__init__(self.message)
...
# High number of retries is needed for feetech motors.
NUM_READ_RETRY = 20
NUM_WRITE_RETRY = 20
